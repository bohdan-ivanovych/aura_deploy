...
export default function SettingsPage() {
      ...
      debouncedSave.current = setTimeout(async () => {
        try {
          const res = await fetch('/api/settings', {
            ...
            body: JSON.stringify({ nativeLanguage, cardPreference, explanationLanguage, targetAccent, name: displayName, username, stealthInjectVocab, stealthInjectGrammar }),
          });
          const data = await res.json();
          if (res.status === 409) {
  ...
  }, [nativeLanguage, cardPreference, explanationLanguage, targetAccent, displayName, username, stealthInjectVocab, stealthInjectGrammar, loading]);
