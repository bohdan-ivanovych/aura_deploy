...
import { Brain, TrendingUp, BookOpen, ChevronDown, MousePointer2 } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="max-w-5xl w-full mx-auto px-1 md:px-8 flex flex-col min-h-full gap-1">
        ...
        {typingSessionId === selectedSessionId && (
          <div className="flex items-end gap-2 pl-1 md:pl-0">
            ...
            <div className="px-3 py-2 md:px-4 md:py-2.5 rounded-2xl rounded-bl-sm flex items-center gap-1.5"
