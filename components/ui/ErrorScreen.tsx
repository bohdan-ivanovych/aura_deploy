    ...
    <div className="min-h-[60vh] flex items-center justify-center p-6">
      ...
      >
        <div
          ...
          style={{
            backgroundImage: 'repeating-linear-gradient(0deg, rgba(0,212,212,1) 0px, transparent 1px, transparent 5px)',
          }}
        />
        ...
        <div className="relative space-y-1">
          <div className="flex items-center gap-2">
            ...
            />
            <p className="text-[9px] font-black uppercase tracking-[0.45em]" style={{ color: 'rgba(0,212,212,0.6)' }}>
              SYSTEM · Error Code {code}
            </p>
          </div>
          <h1 className="text-2xl font-black tracking-tight" style={{ color: '#00d4d4', textShadow: '0 0 20px rgba(0,212,212,0.5)' }}>
            {title}
          </h1>
        </div>
        ...
        {onReset && (
          <button
            ...
            onMouseEnter={e => {
              ...
              (e.currentTarget as HTMLButtonElement).style.boxShadow = '0 0 30px rgba(0,212,212,0.25)';
            }}
            onMouseLeave={e => {
              (e.currentTarget as HTMLButtonElement).style.background = 'rgba(0,212,212,0.12)';
              (e.currentTarget as HTMLButtonElement).style.boxShadow = '0 0 20px rgba(0,212,212,0.1)';
            }}
          >
            ⟳ Reboot
          </button>
